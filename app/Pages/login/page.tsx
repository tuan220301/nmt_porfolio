  ...
  return (
    <div className={isMobileAtom ? "w-full" : "w-1/2"}>
      <div className="w-full flex items-center justify-center mb-6 text-center text-lg">
        With this feature, I can prove who I am and then upload my personal
        projects to this portfolio
      </div>
      ...
      <div
        className={`w-full flex items-center ${isMobileAtom ? "justify-center" : "justify-between"}`}
      >
        {isMobileAtom ? (
          <></>
        ) : (
          <div>
            <Suspense fallback={<Loading />}>
              <div style={{ height: "400px", width: "250px" }}>
                <Spline scene="https://prod.spline.design/kKTerfjRkSZKgYVA/scene.splinecode" />
              </div>
            </Suspense>
          </div>
        )}
        <div
          className={`flex flex-col ${isMobileAtom ? "w-full" : "w-1/2"} gap-2 justify-center mt-4`}
        >
          <div>Email:</div>
          <div className="h-12">
            <InputComponent
          ...
          <div>
            <div className="w-full flex items-center justify-center mt-6">
              <button
                className={`${isLoading ? "flex items-center justify-between" : ""} hover-border border-2 border-transparent rounded-md text-lg px-6 py-2 w-36`}
