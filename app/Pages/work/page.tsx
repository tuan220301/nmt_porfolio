...
const AboutPage = () => {
  ...
  const projectList: ProjecType[] = [
    ...
    { id: 4, url: "work/detail/HaiNam", img: '/img/HaiNam.png', title: 'Hai Nam', desc: 'This is a project about an Android mobile app used for scanning QR code information to support warehouse import and export needs, as well as inventory management, product information entry for different stages, and label printing.' },
  ];
